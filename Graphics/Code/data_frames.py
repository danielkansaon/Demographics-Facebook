...
class Region:
    ...
    def __init__():
        self.data_frame_bolsonaro = [pd.DataFrame(
        {
        ...
        self.data_frame_haddad = [pd.DataFrame(
        {
        ...
        self.data_frame_lula = [pd.DataFrame(
        {
        ...
        self.data_frame_ciro = [pd.DataFrame(
        {
        ...
        self.data_frame_marina = [pd.DataFrame(
        {
        ...
        self.data_frame_alckmin = [pd.DataFrame(
        {
        ...
        self.data_frame_alvaro = [pd.DataFrame(
        {
